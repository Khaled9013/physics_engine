...
Current implementation stage: Phase 2.2 visual realism verified; 33/33 Python tests, 3/3 CTest targets, sanitizer pass, clean fresh Debug build, and GPU smoke passed.
